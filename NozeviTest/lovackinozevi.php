...
<html class="no-js" lang="en" dir="ltr">
  ...
  <div class="large-4 columns sizeo">
    ...
    <div class="image-wrapper overlay-fade-in">
      ...
      <img src="<?php echo $putanjaNozevi; ?>img/two1.jpg"" alt="Vrhunska kvaliteta." />
      
      <div class="image-overlay-content">
        <h2>two sides handle</h2>
  ...
  <div class="large-4 columns sizeo">
    ...
    <div class="image-wrapper overlay-slide-in-left">
      ...
      <img src="<?php echo $putanjaNozevi; ?>img/noz.jpg"" alt="Vrhunska kvaliteta." />
      
      <div class="image-overlay-content">
        <h2>one side handle</h2>
        <p class="price">€49.99</p>
  ...
  <div class="large-4 columns sizeo">
    ...
    <div class="image-wrapper overlay-fade-in-new-background">
      ...
      <img src="<?php echo $putanjaNozevi; ?>img/spec1.jpg"" alt="Vrhunska kvaliteta." />
