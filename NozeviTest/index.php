...
<div class="row">
      ...
      <div class="large-12 columns sizeo">
          <h2>Novosti</h2> <button type="submit" class="button tiny desno" data-open="obavijest"> Dodaj obavijest</button><br>                                   
        <hr class="hrr"/>                
        ...
        <div class="large-8 columns sizeo">
            ...
            <div class="reveal" id="obavijest" data-reveal data-close-on-click="true" data-animation-in="fade" data-animation-out="fade-out">
               ...
               <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
                     <fieldset class="fieldset">
						...
						<div class="row">
                                                    ...
                                                    <div class="large-6 columns lijevo">
